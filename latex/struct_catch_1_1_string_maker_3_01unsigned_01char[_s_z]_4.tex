\section{Catch\+::String\+Maker$<$ unsigned char[SZ]$>$ Struct Template Reference}
\label{struct_catch_1_1_string_maker_3_01unsigned_01char[_s_z]_4}\index{Catch::StringMaker$<$ unsigned char[SZ]$>$@{Catch::StringMaker$<$ unsigned char[SZ]$>$}}
